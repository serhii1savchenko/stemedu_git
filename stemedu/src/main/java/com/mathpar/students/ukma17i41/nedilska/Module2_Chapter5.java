...
public class Module2_Chapter5 {
    ...
    public static void main(String[] args) throws MPIException, IOException, ClassNotFoundException {
        ...
        /**
		 * Run: 
		 * openmpi/bin/mpirun --hostfile hostfile -np 4 java -cp /home/nedilska/stemedu/target/classes com/mathpar/students/ukma17i41/nedilska/Module2_Chapter5
         * I'm processor 1
         * I'm processor 2
         * I'm processor 3
         * res = 
        ...
        /**
		 * openmpi/bin/mpirun --hostfile hostfile -np 8 java -cp /home/nedilska/stemedu/target/classes com/mathpar/students/ukma17i41/nedilska/Module2_Chapter5
         * I'm processor 1
         * I'm processor 2
         * I'm processor 3
         * I'm processor 4
        ...
        /**
		 * openmpi/bin/mpirun --hostfile hostfile -np 8 java -cp /home/nedilska/stemedu/target/classes com/mathpar/students/ukma17i41/nedilska/Module2_Chapter5 5
         * I'm processor 1
         * I'm processor 2
         * I'm processor 3
         * I'm processor 4
         ...
         * [22, 23, 2,  6,  14]
         * [7,  19, 25, 1,  25]]
         * Vector B = [26, 27, 19, 8, 26]
         * rank = 0 row = [19, 28, 10, 17, 18]
         * rank = 0 row = [21, 16, 21, 14]
         * rank = 0 row = [20, 15, 16, 9, 6]
         * rank = 0 row = [22, 23, 2, 6, 14]
         * rank = 0 row = [7, 19, 25, 1, 25]
         * rank = 1 B = [26, 27, 19, 8, 26]
         * send result
         * rank = 2 B = [26, 27, 19, 8, 26]
         * send result
         * rank = 3 B = [26, 27, 19, 8, 26]
         * rank = 5 B = [26, 27, 19, 8, 26]rank = 6 B = [26, 27, 19, 8, 26]
         * 
         * rank = 7 B = [26, 27, 19, 8, 26]
         * rank = 4 B = [26, 27, 19, 8, 26]
        ...
        /**
		 * openmpi/bin/mpirun --hostfile hostfile -np 8 java -cp /home/nedilska/stemedu/target/classes com/mathpar/students/ukma17i41/nedilska/Module2_Chapter5 5 5
         * I'm processor 2
         * I'm processor 3
         * I'm processor 4
         * I'm processor 5
