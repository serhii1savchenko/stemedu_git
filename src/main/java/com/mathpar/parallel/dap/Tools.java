...
public class Tools {
    ...
    public static DropTask doNewDrop(int type, int aminId, int dropId, int procId, int recNum, Element[] data) {
        DropTask newDrop = Tools.getDropObject(type);
    ...
    public static void sendObject(Object a, int proc, int tag) throws MPIException, IOException {
        ...
        System.out.println("IN sendObject Send Object to processor " + proc);
    ...
    public static Object recvObject(int proc, int tag) throws MPIException, IOException, ClassNotFoundException {
        ...
        res = ois.readObject();
        System.out.println("IN recvObject Receive Object from " + proc);
        return res;
    }
    ...
    public static Object[] recvObjects(int m, int proc, int tag) throws MPIException {
        ...
        System.out.println("IN recvObjects Receive Objects from " + proc);
