...
public class ObjectArrayMain {
    ...
    // mpirun -n 2 java -cp "/home/solomka/NetBeansProjects/stemedu/target/classes" "com/mathpar/students/ukma17m1/yaremko/src/lab1/ObjectArrayMain"
    /*
    ...
    */
    public static void main(String[] args) throws MPIException, IOException, ClassNotFoundException {
        ...
        if (myrank == 1) {
            ...
            MPILibrary.sendArrayOfObjects(cars, 0, 0);
        } else {
            Object[] receviedCars = MPILibrary.recvArrayOfObjects(2, 1, 0);
