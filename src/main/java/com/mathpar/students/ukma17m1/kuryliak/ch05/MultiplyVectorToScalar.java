...
public class MultiplyVectorToScalar {
    ...
    // mpirun -np 4 java -cp target/classes com.mathpar.students.ukma17m1.kuryliak.ch05.MultiplyVectorToScalar 9 10
    ...
    I'm processor 3
    I'm processor 2
    Vector B = [11, 23, 29, 28, 19, 12, 10, 22, 14]
    rank = 1 B = [28, 19]
    rank = 2 B = [12, 10]
    rank = 3 B = [22, 14]
    send result
    send result
    send result
    B * S = [110, 230, 290, 280, 190, 120, 100, 220, 140]
    */
