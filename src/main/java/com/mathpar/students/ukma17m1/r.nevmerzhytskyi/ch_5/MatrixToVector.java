...
public class MatrixToVector {
    ...
    /**
     * docker@estimate:/tmp/module-2/out/production/module-2$ mpirun -np 4 java MatrixToVector 4
     * processor 2
     * processor 3
     * processor 1
     * Matrix A =
    ...
    public static void main(String[] args) throws MPIException, IOException, ClassNotFoundException {
        ...
        if (rank == 0) {
            ...
            System.out.println("A x B = " + new VectorS(result).toString(ring));
        } else {
