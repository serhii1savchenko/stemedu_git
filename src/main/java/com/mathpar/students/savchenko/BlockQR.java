...
//        System.out.println("Test: \n" + Q2.multiplyMatr(M1, ring).toString());
    ...
    public static MatrixD[] block4(MatrixD input) throws WrongDimensionsException {
        ...
        if (n == 1) {
            ...
            MatrixD A = Utils.getSubMatrix(matrix, 0, h-1, 0, h-1);
            MatrixD B = Utils.getSubMatrix(matrix, 0, h-1, h, n-1);
            MatrixD C = Utils.getSubMatrix(matrix, h, n-1, 0, h-1);
            MatrixD D = Utils.getSubMatrix(matrix, h, n-1, h, n-1);
